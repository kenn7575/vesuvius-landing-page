  ...
  return (
      ...
      <header className="relative bg-gray-100 text-black">
        <h1 className="absolute left-1/2 transform -translate-x-1/2 text-2xl p-4 z-20">
          <a href="/" className="hover:italic">Cafe Vesuvius</a>
        </h1>
        ...
        <nav className="relative top-0 left-0 w-full p-4">
          ...
          <ul
              className="peer-checked:h-auto peer-checked:overflow-visible h-0 overflow-hidden md:h-auto md:overflow-visible text-right bg-gray-100 md:bg-transparent space-y-2 md:space-y-0"
          >
            <li className="block md:inline">
              <a href="/menu" className="text-sm hover:italic block md:inline md:pr-4">
                Menu
              </a>
            </li>
            <li className="block md:inline">
              <a href="/reservation" className="text-sm hover:italic block md:inline">
                Reservation
              </a>
            </li>
          </ul>
      ...
      <footer className="bg-gray-100 px-4 py-8 w-full mt-auto">
        <div className="container mx-auto flex flex-col items-center text-gray-700">
          ...
          <p className="text-center mt-4">&copy; {new Date().getFullYear()} Cafe Vesuvius. All Rights
            Reserved.</p>
        </div>
      </footer>
      </body>
